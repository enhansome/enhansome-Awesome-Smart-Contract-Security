...
* [KEVM](https://github.com/kframework/evm-semantics) ⭐ 590 | 🐛 90 | 🌐 KCL | 📅 2026-08-27 - K Semantics of the Ethereum Virtual Machine (EVM)
...
* [Echidna](https://github.com/trailofbits/echidna) ⭐ 3,171 | 🐛 103 | 🌐 Haskell | 📅 2026-08-26 - Fuzzer for Ethereum smart contracts. Uses property testing to generate malicious inputs that break smart contracts.
